...
var _user$project$Parallax$perspective = 300;
var _user$project$Parallax$translateZ = function (speed) {
	return speed * _user$project$Parallax$perspective;
};
var _user$project$Parallax$scale = function (speed) {
	return 1 + ((_user$project$Parallax$translateZ(speed) * -1) / _user$project$Parallax$perspective);
};
var _user$project$Parallax$layerStyle = function (speed) {
	return {
		ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'willChange', _1: 'transform'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'transformOrigin', _1: '100%'},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										...
										_1: A2(
											...
											A2(
												...
												_elm_lang$core$Basics$toString(
													_user$project$Parallax$translateZ(speed)),
												A2(
													_elm_lang$core$Basics_ops['++'],
													'px) scale(',
													A2(
														_elm_lang$core$Basics_ops['++'],
														_elm_lang$core$Basics$toString(
															_user$project$Parallax$scale(speed)),
														')'))))
									},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'zIndex',
											_1: _elm_lang$core$Basics$toString(speed * -100)
										},
										_1: {ctor: '[]'}
									}
								}
...
var _user$project$Parallax$imageLayerStyle = function (speed) {
	return {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
		_1: {
...
var _user$project$Parallax$groupStyle = function (_p0) {
	var _p1 = _p0;
	return {
		ctor: '::',
		...
		_1: {
			...
			_0: {
				...
				_1: A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(_p1.frames * 100),
					'vh')
			},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'transformStyle', _1: 'preserve-3d'},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
...
var _user$project$Parallax$baseStyle = {
	ctor: '::',
	...
	_1: {
		...
		_0: {
			...
			_1: A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(_user$project$Parallax$perspective),
				'px')
		},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'overflowX', _1: 'hidden'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'overflowY', _1: 'auto'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'transform', _1: 'translate3d(0, 0, 0)'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'perspectiveOrigin', _1: '100%'},
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Parallax$layer = F3(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_0: _elm_lang$html$Html_Attributes$style(
							_user$project$Parallax$imageLayerStyle(_p6)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src(_p5._0.src),
							_1: {ctor: '[]'}
						}
					},
					attributes),
			...
			return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							_user$project$Parallax$layerStyle(_p6)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('parallax-layer'),
							_1: {ctor: '[]'}
						}
					},
					attributes),
...
var _user$project$Parallax$layerGroup = F3(
		...
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(
						_user$project$Parallax$groupStyle(config)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('parallax-group'),
						_1: {ctor: '[]'}
					}
				},
				attributes),
...
var _user$project$Parallax$base = F2(
	function (config, children) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(_user$project$Parallax$baseStyle),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('parallax-base'),
					_1: {ctor: '[]'}
				}
			},
			children);
	});
var _user$project$Parallax$initialLayerConfig = {speed: 1, image: _elm_lang$core$Maybe$Nothing};
var _user$project$Parallax$BaseConfig = {};
var _user$project$Parallax$GroupConfig = F2(
	function (a, b) {
		return {frames: a, position: b};
	});
var _user$project$Parallax$LayerConfig = F2(
	function (a, b) {
		return {speed: a, image: b};
	});
var _user$project$Parallax$Img = function (a) {
	return {src: a};
};
var _user$project$Parallax$Back = {ctor: 'Back'};
var _user$project$Parallax$Front = {ctor: 'Front'};
var _user$project$Parallax$initialGroupConfig = {frames: 1, position: _user$project$Parallax$Front};

var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Main$absoluteCenter = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'position', _1: 'absolute'},
	_1: {
		ctor: '::',
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A2(
				_user$project$Parallax$base,
				{},
				{
					ctor: '::',
					_0: A3(
						_user$project$Parallax$layerGroup,
						{frames: 1, position: _user$project$Parallax$Front},
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'background', _1: '#112532'},
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						},
						A2(
							...
							A2(
								...
								function (_p0) {
									var _p1 = _p0;
									return A3(
										_user$project$Parallax$layer,
										{speed: 0.4, image: _elm_lang$core$Maybe$Nothing},
										{ctor: '[]'},
										{
											ctor: '::',
											_0: A2(
															...
															_1: {
																...
																_1: {
																	...
																	_1: {
																		...
																		_1: {
																			ctor: '::',
																			_0: {ctor: '_Tuple2', _0: 'color', _1: 'rgb(205, 205, 0)'},
																			_1: {ctor: '[]'}
																		}
																	}
																}
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('fa fa-star fa-2x'),
															_1: {ctor: '[]'}
														},
														{ctor: '[]'}),
													_1: {ctor: '[]'}
								...
								A2(
									...
									{ctor: '[]'},
									A2(_elm_lang$core$Dict$get, 0, model.positionStars))),
							A2(
								_elm_lang$core$Basics_ops['++'],
								A2(
									_elm_lang$core$List$map,
									function (_p2) {
										...
										return A3(
											_user$project$Parallax$layer,
											{speed: 0.2, image: _elm_lang$core$Maybe$Nothing},
											{ctor: '[]'},
											{
												ctor: '::',
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('fa fa-star fa-lg'),
																_1: {ctor: '[]'}
															},
															{ctor: '[]'}),
														_1: {ctor: '[]'}
									...
									A2(
										_elm_lang$core$Maybe$withDefault,
										{ctor: '[]'},
										A2(_elm_lang$core$Dict$get, 1, model.positionStars))),
								A2(
									_elm_lang$core$List$map,
									function (_p4) {
										var _p5 = _p4;
										return A3(
											_user$project$Parallax$layer,
											{speed: 0, image: _elm_lang$core$Maybe$Nothing},
											{ctor: '[]'},
											{
												ctor: '::',
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('fa fa-star'),
																_1: {ctor: '[]'}
															},
															{ctor: '[]'}),
														_1: {ctor: '[]'}
									...
									A2(
										_elm_lang$core$Maybe$withDefault,
										{ctor: '[]'},
										A2(_elm_lang$core$Dict$get, 2, model.positionStars)))))),
					_1: {
						ctor: '::',
						_0: A3(
							_user$project$Parallax$layerGroup,
							_user$project$Parallax$initialGroupConfig,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'background', _1: '#2D6786'},
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
							{
								...
								_0: A3(
									_user$project$Parallax$layer,
									{speed: 0.1, image: _elm_lang$core$Maybe$Nothing},
									{ctor: '[]'},
									{
										ctor: '::',
										_0: A2(
												...
												_0: _elm_lang$html$Html_Attributes$style(
													{
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: {ctor: '_Tuple2', _0: 'left', _1: '80%'},
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'transform', _1: 'translate(-80%, 10%)'},
																	_1: {
																		ctor: '::',
								...
								_1: {
									...
									_0: A3(
										_user$project$Parallax$layer,
										{speed: 0.5, image: _elm_lang$core$Maybe$Nothing},
										{ctor: '[]'},
										{
											ctor: '::',
											_0: A2(
													...
													_0: _elm_lang$html$Html_Attributes$style(
														{
															...
															_1: {
																ctor: '::',
																_0: {ctor: '_Tuple2', _0: 'top', _1: '110%'},
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'left', _1: '20%'},
																	_1: {
																		ctor: '::',
																		_0: {ctor: '_Tuple2', _0: 'transform', _1: 'translate(-20%, 110%)'},
																		_1: {
																			ctor: '::',
																			_0: {ctor: '_Tuple2', _0: 'color', _1: 'white'},
																			_1: {
						...
						_1: {
							...
							_0: A3(
								_user$project$Parallax$layerGroup,
								{frames: 1, position: _user$project$Parallax$Back},
								{ctor: '[]'},
								{
									ctor: '::',
									_0: A3(
										_user$project$Parallax$layer,
										{
											...
											image: _elm_lang$core$Maybe$Just(
												_user$project$Parallax$Img('img/image-1.jpg'))
										},
										{ctor: '[]'},
										{ctor: '[]'}),
									_1: {ctor: '[]'}
							...
							_1: {
								...
								_0: A3(
									...
									},
									{
										...
										_0: A3(
											_user$project$Parallax$layer,
											{speed: 0.8, image: _elm_lang$core$Maybe$Nothing},
											{ctor: '[]'},
											{
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$style(_user$project$Main$absoluteCenter),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('The End'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
		...
		if (_p6.ctor === 'NoOp') {
			...
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					model,
					{
						positionStars: A3(_elm_lang$core$Dict$insert, _p6._0, _p6._1, model.positionStars)
					}),
				{ctor: '[]'});
		}
	});
var _user$project$Main$initialModel = {positionStars: _elm_lang$core$Dict$empty};
var _user$project$Main$Model = function (a) {
	return {positionStars: a};
};
var _user$project$Main$StarPosition = F2(
	function (a, b) {
		return {ctor: 'StarPosition', _0: a, _1: b};
	});
	...
	_1: _elm_lang$core$Platform_Cmd$batch(
		A2(
			...
			function (idx) {
				return A2(
					_elm_lang$core$Random$generate,
					_user$project$Main$StarPosition(idx),
					A2(
